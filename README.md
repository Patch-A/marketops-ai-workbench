...
> 当前状态：M1 纵向切片进行中。M1-01 项目导入已通过真实 Chromium、PostgreSQL 18.4、独立审查和同 SHA GitHub CI；M1-02 的可信提取、持久审核与 HTTP API 已通过受限工程门禁，浏览器审核 UI 和 M1-02 整体验收尚未完成。知识库、连接器和 AI 自动化尚未实现。
